            ...
            switch (args[1]) {
                ...
                case "invite":
                    if (args.length == 2)
                        ...
                        Member tagged = event.getGuild().getMemberById(args[1].replace("<@", "").replace(">", ""));
                        if (tagged == null)
